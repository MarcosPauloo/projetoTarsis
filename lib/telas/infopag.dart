...
class _TelaInfoState extends State<Info> {
  @override
      ...
      appBar: AppBar(
        title: Align(
          child: Text(
            "INFORMAÇÕES",
            style:
                GoogleFonts.bebasNeue(color: Color(0xFFde3163), fontSize: 37),
          ),
    ...
    children: <Widget>[
      Align(
        ...
        child: Text(
          ...
          style:
              GoogleFonts.montserrat(color: Color(0xFFde3163), fontSize: 18.5),
        ),
      ),
      Align(
        child: Text(
      ...
      Align(
       ...
       Align(
        alignment: Alignment.centerLeft,
        child: Text(
          '\n\nOs impedimentos definitivos para doar sangue',
          style: GoogleFonts.montserrat(color: Color(0xFFde3163), fontSize: 17),
        ),
      ),
      Align(
